...
export default class labelSetting extends Component {
    constructor(props) {
    super(props);
    this.state = {
      title: '商品属性',
  ...
  loadPushArticles(){
    setTimeout(() => {
        ...
        NetUtils.get('physical/goods/property/pageList', params, (result) => {
  ...
  _renderEmptyTweets= () => (
      <View style={{width:ScreenUtils.scaleSize(750),height:ScreenUtils.scaleSize(100),backgroundColor:'white',justifyContent:'center',alignItems:'center'}}>
        <Text style={{color:'black',fontSize:ScreenUtils.setSpText(9)}}>暂无属性，请添加</Text>
      </View>
  )

  _renderSkuListItem(item,navigate){
    return (
             <TouchableOpacity onPress={() => navigate('labelAdd',{id:item.id})} style={{width:ScreenUtils.scaleSize(750),height:ScreenUtils.scaleSize(94),backgroundColor:'white',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
               <Text style={{width:ScreenUtils.scaleSize(335),fontSize:ScreenUtils.setSpText(9),color:'black'}}>{item.property_name}</Text>
            ...
            <View style={styles.container}>
                ...
                <View style={{backgroundColor:'white',width:ScreenUtils.scaleSize(750),height:ScreenUtils.scaleSize(this.state.statusBarHeight),backgroundColor:'white'}}>
                    ...
                    <View style={{backgroundColor:'white',flexDirection:'row',width:ScreenUtils.scaleSize(750),height:ScreenUtils.scaleSize(88),backgroundColor:'white',alignItems:'center'}}>
                      ...
                      <TouchableOpacity onPress={() => navigate('labelAdd',{id:0})} style={{width:ScreenUtils.scaleSize(150),height:ScreenUtils.scaleSize(50),alignItems:'flex-end',justifyContent:'center'}}>
