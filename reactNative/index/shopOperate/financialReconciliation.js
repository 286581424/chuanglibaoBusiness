...
export default class financialReconciliation extends Component {
    constructor(props) {
    super(props);
    this.state = {
      title: '财务对账',
  ...
  updateHistoryBill(){
    setTimeout(() => {
        let params = "?mobile=" + this.state.phone +'&token=' + this.state.token[1]+'&pageNum=1&pageSize=5';
  ...
  setStatusBarHeight(){
    ...
    _renderHeader= () => (
      <View style={{flexDirection:'row',width:ScreenUtils.scaleSize(750),height:ScreenUtils.scaleSize(80),backgroundColor:'white',alignItems:'center',borderBottomColor:'#EEEEEE',borderBottomWidth:ScreenUtils.scaleSize(3)}}>
        ...
        <TouchableOpacity onPress={() => this.props.navigation.navigate('historicalBill')} style={{left:ScreenUtils.scaleSize(30),width:ScreenUtils.scaleSize(240),height:ScreenUtils.scaleSize(40),justifyContent:'flex-end',flexDirection:'row'}}>
          <Text style={{width:ScreenUtils.scaleSize(200),fontSize:ScreenUtils.setSpText(8),color:'gray'}}>查看所有账单</Text>
    ...
    _goToCheckBalance(navigate){
      // navigate('balanceWater');
    }
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <View style={{backgroundColor:'white',width:ScreenUtils.scaleSize(750),height:ScreenUtils.scaleSize(this.state.statusBarHeight),backgroundColor:'#F3A50E'}}>
                  ...
                  <View style={{width:ScreenUtils.scaleSize(750),height:ScreenUtils.scaleSize(150),backgroundColor:'white',flexDirection:'row',alignItems:'center'}}>
                    <View style={{left:ScreenUtils.scaleSize(30),width:ScreenUtils.scaleSize(690/2),height:ScreenUtils.scaleSize(110),justifyContent:'center'}}>
                      <Text style={{top:ScreenUtils.scaleSize(-5),fontSize:ScreenUtils.setSpText(8),color:'gray'}}>可提现余额</Text>
                      <Text style={{top:ScreenUtils.scaleSize(20),fontSize:ScreenUtils.setSpText(9),color:'#434343'}}>¥ 0</Text>
                    </View>
                    <View style={{left:ScreenUtils.scaleSize(30),width:ScreenUtils.scaleSize(690/2),height:ScreenUtils.scaleSize(110)}}>
                  ...
                  <View style={{width:ScreenUtils.scaleSize(750),height:ScreenUtils.scaleSize(100),backgroundColor:'white',flexDirection:'row',alignItems:'center'}}>
                    <Image resizeMode={'stretch'} style={{width:ScreenUtils.scaleSize(40),height:ScreenUtils.scaleSize(47),left:ScreenUtils.scaleSize(20)}} source={require('../images/MenDian/water.png')}/>
                    <Text style={{left:ScreenUtils.scaleSize(40),width:ScreenUtils.scaleSize(250),fontSize:ScreenUtils.setSpText(8),color:'black'}}>查看流水</Text>
                    <TouchableOpacity onPress={() => this._goToCheckBalance(navigate)} style={{left:ScreenUtils.scaleSize(240),width:ScreenUtils.scaleSize(200),height:ScreenUtils.scaleSize(80),alignItems:'center',justifyContent:'center'}}>
                      <Image resizeMode={'stretch'} source={require('../images/shopSecond/shop_second_more.png')} style={{left:ScreenUtils.scaleSize(80),width:ScreenUtils.scaleSize(14*1.5),height:ScreenUtils.scaleSize(25*1.5)}}/>
                    </TouchableOpacity>
                  </View>
                  ...
                  <View style={{width:ScreenUtils.scaleSize(750),height:ScreenUtils.scaleSize(260),backgroundColor:'white'}}>
                    <View style={{left:ScreenUtils.scaleSize(30),width:ScreenUtils.scaleSize(690),height:ScreenUtils.scaleSize(80),flexDirection:'row',alignItems:'center'}}>
                      <Text style={{width:ScreenUtils.scaleSize(500),fontSize:ScreenUtils.setSpText(8),color:'black'}}>预计今日收入</Text>
                      <Text style={{width:ScreenUtils.scaleSize(190),textAlign:'right',fontSize:ScreenUtils.setSpText(8),color:'red'}}>¥ {this.state.totalMoney-this.state.refundMoney}</Text>
                    </View>
