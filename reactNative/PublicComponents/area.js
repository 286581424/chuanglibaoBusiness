...
export default class area extends Component{
  ...
  componentDidMount() {
    ...
    this._loadCityData(params.city);
  }
  ...
  _itemPress(item,navigate,params){
    ...
    data.push(item);
    navigate('townOrStreet',{area:item,data:data,key:params.key});
  }
